...
$string['privacy:metadata:exelearning_tracking_events'] = 'Audit log of the xAPI statements ingested for each user, kept for idempotency and grade traceability.';
$string['privacy:metadata:exelearning_tracking_events:objectid'] = 'For an answered statement, the iDevice the statement scored.';
$string['privacy:metadata:exelearning_tracking_events:registration'] = 'The attempt-grouping token (xAPI registration) the statement belongs to.';
$string['privacy:metadata:exelearning_tracking_events:scaled'] = 'The scaled score (0..1) accepted from the statement.';
$string['privacy:metadata:exelearning_tracking_events:statementid'] = 'The unique id (UUID) of the xAPI statement.';
$string['privacy:metadata:exelearning_tracking_events:timecreated'] = 'When the statement was ingested.';
$string['privacy:metadata:exelearning_tracking_events:userid'] = 'The user the statement was attributed to.';
$string['privacy:metadata:exelearning_tracking_events:verb'] = 'The xAPI verb of the statement (answered, completed, passed, failed, initialized, terminated).';
...
$string['xapisettings_desc'] = 'Grading channel for packages that emit xAPI statements. SCORM 1.2 stays the compatibility path for packages without the emitter.';
