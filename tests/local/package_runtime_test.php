...
final class package_runtime_test extends advanced_testcase {
    ...
    public function test_refresh_rebuilds_revision_and_preserves_history(): void {
        ...
        $items = $DB->get_records('exelearning_grade_item', ['exelearningid' => $instance->id]);
        ...
        $this->assertEquals($items, $DB->get_records('exelearning_grade_item', ['exelearningid' => $instance->id]));
